<template>
  <div class="home page-component">
    ...
    <div v-for="(item,index) in list" :key="index" class="v-scroll-list hospital-list">



      <div class="v-card clickable list-item space" @click="show(item.hoscode)">
      <div class="">
      <div
